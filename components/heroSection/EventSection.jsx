...
const EventSection = () => {
  return (
    <div className="col-span-6 md:col-span-2 w-full bg-[#E5DFCF] h-[600px] md:h-[658px] rounded-[10px] py-[23px] px-[26px] relative ">
      ...
      <div className="flex flex-col justify-between items-stretch gap-5 mt-4 overflow-hidden overflow-y-scroll md:max-h-[60vh] scrollbar">
        <Link class="twitter-timeline" href="https://twitter.com/shreyansh487?ref_src=twsrc%5Etfw">
