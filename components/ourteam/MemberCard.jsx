...
const MemberCard = () => {
  return (
    <div className="card">
      <div className="card-content card-front col-span-1 flex flex-col items-center w-fit rounded-lg">
      ...
      <div className="card-content card-back col-span-1 flex flex-col bg-white w-fit h-[230px] rounded-lg px-4 py-5 gap-[12px]">
        <div>
