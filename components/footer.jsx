      ...
      <div className="relative  bg-white z-0">
        <div className="w-full flex space-between ">
          ...
          <Image
            ...
            width={260}
            height={215}
            className="absolute  z-0 -top-16 right-0"
          />
        </div>

        <div className="bg-[#413833]  absolute">
          <h1 className="text-white text-4xl font-bold text-center py-2 border-b-1 tracking-4">
          ...
          <div className="md:flex flex-2 justify-evenly text-center items-center border-b-2 border-white space-y-2">
            ...
            <div className="">
              <h1 className="text-xl text-center uppercase text-white ">
                Location
              </h1>
              <Image
                src={location}
                alt="members"
                className="object-cover p-3 w-full flex justify-center items-center"
              />
            </div>
