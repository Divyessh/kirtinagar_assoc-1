...
const Title = () => {
  return (
    <div className="text-center">
      <h1 className="font-[700] text-[18px] leading-[20px] md:text-[50px] md:leading-[75px]">WOODMAN FURNITURE INDIA PVT. LTD.</h1>
      ...
      <Link href="/services" className="text-center flex justify-center items-center mt-[15px] mb-[20px]">
        ...
        >
          <h1 className="font-[400] text-[14px] md:text-[20px]">VISIT WEBSITE</h1>
