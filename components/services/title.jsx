    ...
    <>
      <div className="text-center flex justify-center items-center">
        <div className="flex flex-col justify-center items-center gap-3 w-1/2">
          <div className="flex">
            <h1 className="font-[700] text-[18px] text-black md:text-[50px] leading-[20px] md:leading-[75px]">
              {name}
            </h1>
            {isUser === id && (
          ...
          <p className="font-[300] text-[#302f2f] text-[15px] md:text-[23px]">
            New Delhi, India
          </p>
        </div>
        ...
        >
          ...
          >
            <h1 className="font-[400] text-[14px] text-black md:text-[20px]">
              VISIT WEBSITE
            </h1>
