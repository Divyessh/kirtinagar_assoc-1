  ...
  return (
    ...
    <>
      ...
      <div className="text-black text-xl bg-primary px-12 py-6 ">
        <span className="flex space-x-5">
          <span className="w-[56%]">
            ...
            <button type="button" className=" btn bg-primary border-2  text-black hover:text-white rounded-lg">
              Read more {'>'}
            </button>
          </span>
          <span className="w-[40%] ">
      ...
      <section>
        <div>ACTIVITIES</div>
        <div>
          1. To carry out day-to-day work. 2. To discuss various matters/issues in the managing committee meeting. 3. To ensure effective
          and efficient implementation of decisions/ programmes of the managing committee. 4. Shall utilize the funds judiciously in the
          interest of members of the Association. 5. Share the audited accounts with the members. 6. To arrange for get-together & cultural
          programmes. 7. To look into all legal possibilities for the welfare of its members.
        </div>
      </section>
    </>
  );
